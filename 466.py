...
header_name =dp.columns.values.tolist()
...
y = zero_rate
plt.yticks(frontproperties = 'Times New Roman', size=16)
plt.xticks(frontproperties = 'Times New Roman', size=16)
plt.plot(y)
...
plt.title('2021-2025 Spot curve', font1)
plt.show()
